@extends('layouts.main', ['class' => 'off-canvas-sidebar', 'activePage' => 'register', 'title' => __('SISAV')])
    ...
    <div class="col-lg-4 col-md-6 col-sm-8 ml-auto mr-auto">
      <form class="form" method="POST" action="{{ route('register') }}">
        ...
        <div class="card card-login card-hidden mb-3">
          ...
          <div class="card-body ">
            <p class="card-description text-center">{{ __('O crea una cuenta SISAV') }}</p>
            <!-- Nombre -->
            <div class="bmd-form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
              <div class="input-group">
                ...
                <input type="text" name="name" class="form-control" placeholder="{{ __('Nombres..') }}" value="{{ old('name') }}" required autocomplete="name" autofocus>
              </div>
              @if ($errors->has('name'))
            ...
            <!-- Apellidos -->
            <div class="bmd-form-group{{ $errors->has('lastname') ? ' has-danger' : '' }} mt-3">
              <div class="input-group">
                <div class="input-group-prepend">
                  <span class="input-group-text">
                      <i class="material-icons">face</i>
                ...
                <input type="text" name="lastname" class="form-control" placeholder="{{ __('Apellidos..') }}" value="{{ old('lastname') }}" required>
              </div>
            ...
            <div class="bmd-form-group{{ $errors->has('age') ? ' has-danger' : '' }} mt-3">
              <div class="input-group">
                ...
                <input type="text" name="age" class="form-control" placeholder="{{ __('Edad..') }}" value="{{ old('age') }}" required>
              </div>
              @if ($errors->has('age'))
